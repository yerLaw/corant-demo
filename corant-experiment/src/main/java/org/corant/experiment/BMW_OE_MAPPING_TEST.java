 ...
 * @since
 */
public class BMW_OE_MAPPING_TEST {
  protected static final Logger LOGGER = LoggerFactory.getLogger(BMW_OE_MAPPING_TEST.class);

  public static void main(String[] args) throws Exception {
    Excels.ExcelStreamlizer ta_oe_excel =
        Excels.streamlizer(new FileInputStream("E:\\file_file_file\\test\\BMW_OE_GA_REF.xlsx"));
    Excels.ExcelStreamlizer bmw_oe_excel =
        Excels.streamlizer(new FileInputStream("E:\\file_file_file\\test\\bmw_teil.xlsx"));
    ...
    FileOutputStream out =
        new FileOutputStream("E:\\file_file_file\\test\\bmw_oe_mapping_result.xls");
    Excels.initWorkbook(new XSSFWorkbook(), Streams.streamOf(bmwList.iterator()))
        .createSheet()
        .createRowsFrom(0)
        .write(out);
  }
